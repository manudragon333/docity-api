...
import {
  reqPropertyQueryDataMapping,
  reqQueryDataMapping,
} from "helpers/data_mapping/req_query";
...
export async function saveContactMeRequest(
  ...
  try {
    ...
    const propertyContact: IPropertyContact = propertyContactDataMapping(
      req.body
    );
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.saveContactMeRequest(
        req.userSession,
        propertyContact
      );
...
export async function saveVerifyProperty(
  ...
  try {
    ...
    const propertyRequest: IPropertyRequest = propertyRequestDataMapping(
      req.body,
      req.userSession
    );
    Log.debug("propertyRequest: ", propertyRequest);
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.saveVerifyProperty(
        req.userSession,
        propertyRequest
      );

    Log.debug("serviceResponse: ", serviceResponse);
    const serviceCivilEnggResponse: IServiceResponse =
      await PropertyRequestService.assignPropertyRequestToCivilEngineer(
        serviceResponse.data.id,
        req.body.civilEngineers
      );
    responseBuilder(serviceResponse, res, next, req);
  } catch (error) {
...
export async function updateVerifyPropertyRequest(
  ...
  try {
    ...
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.updateVerifyPropertyRequest(
        req.userSession,
        propertyRequest
      );
    responseBuilder(serviceResponse, res, next, req);
...
export async function getAllPropertyRequests(
  ...
  try {
    ...
    const queryParams: IPropertyRequestListApiRequest =
      reqPropertyQueryDataMapping(req.query);
    queryParams.sortBy = PROPERTY_SORT_FIELDS[queryParams.sortBy];
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.getAllPropertyRequests(
        req.userSession,
        queryParams
      );
    responseBuilder(serviceResponse, res, next, req);
...
export async function getAllPropertyRequestLocations(
  ...
  try {
    ...
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.getAllPropertyRequestLocations(
        req.userSession,
        req.query.search
      );
    responseBuilder(serviceResponse, res, next, req);
...
export async function getAllPropertyContacts(
  ...
  try {
    ...
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.getAllPropertyContacts(
        req.userSession,
        queryParams
      );
    responseBuilder(serviceResponse, res, next, req);
...
export async function savePropertyDocs(
  req: any,
  res: Response,
  next: NextFunction
) {
  try {
    Log.debug("Logged in User: ", req.userSession);
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.savePropertyDocs(req, res);
    responseBuilder(serviceResponse, res, next, req);
  } catch (err) {
...
export async function linkPropertyDoc(
  req: any,
  res: Response,
  next: NextFunction
) {
  try {
    Log.debug("Logged in user:", req.userSession);
    const serviceResponse = await PropertyRequestService.linkPropertyDoc(
      req,
      res
    );
    responseBuilder(serviceResponse, res, next, req);
...
export async function getPropertyDocs(
  ...
  try {
    ...
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.getPropertyDocs(propertyRequestId);
    responseBuilder(serviceResponse, res, next, req);
  } catch (err) {
...
export async function deletePropertyDoc(
  req: any,
  res: Response,
  next: NextFunction
) {
  try {
    ...
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.deletePropertyDoc(propertyDocId);
    responseBuilder(serviceResponse, res, next, req);
  } catch (err) {
    Log.error(TAG, "savePropertyDocs()", err);
    next(err);
...
export async function updatePropertyDocNotes(
  ...
  try {
    ...
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.updatePropertyDocNotes(
        propertyDocId,
        req.body.notes
      );
    responseBuilder(serviceResponse, res, next, req);
...
export async function updatePropertyDocumentWriter(
  ...
  try {
    ...
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.updatePropertyDocumentWriter(
        propertyRequestId,
        req.body
      );
    responseBuilder(serviceResponse, res, next, req);
...
export async function getPropertyRequestDetails(
  req: any,
  res: Response,
  next: NextFunction
) {
...
export async function updatePropertyRequestCivilEngineerResponse(
  ...
  try {
    ...
    Log.debug("Body: ", req.body);
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.updatePropertyRequestCivilEngineerResponse(
        req.userSession,
        propertyRequestId,
        action,
        req.body.estimatedFinishDate
      );
    responseBuilder(serviceResponse, res, next, req);
  } catch (err) {
...
export async function updatePropertyRequestStatus(
  ...
  try {
    ...
    Log.debug("Body: ", req.body);
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.updatePropertyRequestStatus(
        propertyRequestId,
        action
      );
    responseBuilder(serviceResponse, res, next, req);
...
export async function savePropertyDocumentComment(
  req: any,
  res: Response,
  next: NextFunction
) {
  try {
    ...
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.saveDocumentComment(
        req.userSession,
        docId,
        comment
      );
...
export async function fetchPropertyDocumentComment(
  req: any,
  res: Response,
  next: NextFunction
) {
  try {
    ...
    Log.debug("Logged in User: ", req.userSession);
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.getDocumentComment(req.userSession, docId);
    responseBuilder(serviceResponse, res, next, req);
  } catch (err) {
...
export async function updatePropertyDocumentComment(
  req: any,
  res: Response,
  next: NextFunction
) {
  try {
    ...
    const comment: IDocComment = docCommentDataMapping(req.body);
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.updateDocumentComment(
        req.userSession,
        docId,
        commentId,
        comment
...
export async function deletePropertyDocumentComment(
  req: any,
  res: Response,
  next: NextFunction
) {
  try {
    ...
    Log.debug("Logged in User: ", req.userSession);
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.deleteDocumentComment(
        req.userSession,
        docId,
        commentId
      );
...
export async function updatePropertyRequestFinalReport(
  req: any,
  res: Response,
  next: NextFunction
) {
...
export async function sharePropertyRequestFinalReport(
  req: any,
  res: Response,
  next: NextFunction
) {
  try {
    ...
    Log.debug("REQUEST BODY: ", req.body);
    const serviceResponse: IServiceResponse =
      await PropertyRequestService.shareFinalReport(
        req.userSession,
        propertyRequestId,
        req.body
      );
