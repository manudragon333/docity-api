...
export async function saveUser(req: any, res: Response, next: NextFunction) {
    try {
        ...
        const serviceResponse: IServiceResponse = await UserService.saveUser(req.userSession, user);
...
export async function getUsers(req: any, res: Response, next: NextFunction) {
    try {
        ...
        const queryParams: IUserListApiRequest = reqUsersQueryDataMapping(req.query);
        const serviceResponse: IServiceResponse = await UserService.getUsers(req.userSession, queryParams);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
...
export async function getUser(req: any, res: Response, next: NextFunction) {
    try {
        ...
        const serviceResponse: IServiceResponse = await UserService.getUserDetails(userId);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
...
export async function updateUser(req: any, res: Response, next: NextFunction) {
    try {
        ...
        const serviceResponse: IServiceResponse = await UserService.updateUser(req.userSession, user);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
        Log.error(TAG, 'getUser()', error);
        next(error);
...
export async function updateProfileImage(req: any, res: Response, next: NextFunction) {
    try {
        Log.debug('Logged in User: ', req.userSession);
        Log.debug('REQUEST_PARAMS: ', req.params);
        Log.debug('REQUEST_BODY: ', req.body);
        const serviceResponse: IServiceResponse = await UserService.updateProfileImage(req, res);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
...
export async function addUserIdProof(req: any, res: Response, next: NextFunction) {
    try {
        const userId = req.params[PathParams.USER_ID];
        Log.debug('Logged in User: ', req.userSession);
        Log.debug('REQUEST_PARAMS: ', req.params);
        Log.debug('REQUEST_BODY: ', req.body);
        const serviceResponse: IServiceResponse = await UserService.addUserIdProof(req.userSession, userId, req.body,
            req.files);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
...
export async function getUserIdProofs(req: any, res: Response, next: NextFunction) {
    try {
        const userId = req.params[PathParams.USER_ID];
        Log.debug('Logged in User: ', req.userSession);
        Log.debug('REQUEST_PARAMS: ', req.params);
        Log.debug('REQUEST_BODY: ', req.body);
        const serviceResponse: IServiceResponse = await UserService.getIdProofs(userId);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
...
export async function handleUserAction(req: any, res: Response, next: NextFunction) {
    try {
        const userId = req.params[PathParams.USER_ID];
        const action = req.params[PathParams.ACTION];
        Log.debug('Logged in User: ', req.userSession);
        const serviceResponse: IServiceResponse = await UserService.handleUserAction(req.userSession, userId, action);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
...
export async function inviteUser(req: any, res: Response, next: NextFunction) {
    try {
        ...
        const serviceResponse: IServiceResponse = await UserService.inviteUser(req.userSession, req.body, role);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
...
export async function shareReport(req: any, res: Response, next: NextFunction) {
    try {
        ...
        const serviceResponse: IServiceResponse = await UserService.shareReport(req.userSession, req.body, role, userId);
        responseBuilder(serviceResponse, res, next, req);
    } catch (error) {
